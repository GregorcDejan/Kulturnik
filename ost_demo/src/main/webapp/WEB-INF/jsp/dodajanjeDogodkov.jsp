...
<main class="teal lighten-5">
    ...
    <div class="container">
        ...
        <form action="/dodajDogodek" method="post">
            ...
            <div class="row">
                <div class="input-field col s8 offset-s2 ">
                    <select required name="tipDogodka" id="inputKategorija">
                        ...
                        <option value="Razstava">Razstave</option>
            ...
            <div class="row">
                <div class="input-field col s8 offset-s2">
                    <input required type="text" id="datumInput" class="datepicker" name="datum">
                    <label for="datumInput">Datum dogodka</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field col s8 offset-s2">
                    <input required type="text" id="casInput" class="timepicker" name="">
                    <label for="casInput">Čas začetka</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field col s8 offset-s2">
                    <textarea required id="opisDogodkaInput" name="opis" class="materialize-textarea" name="opis"></textarea>
            ...
            <div class="row">
                <div class="file-field input-field col s8 offset-s2">
                        ...
                        <input name="slika" type="text" placeholder="Naložite slike dogodka">

                </div>
            </div>
            <div class="row">
                <div class="input-field col s8 offset-s2">
                    <textarea required id="cenaDogodkaInput" name="cena" class="materialize-textarea" name="cena"></textarea>
                    <label for="cenaDogodkaInput">cena dogodka</label>
                </div>
            </div>
            <div class="row">
